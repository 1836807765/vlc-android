...
public class Util {
    ...
    private static class DialogCallback implements PlaybackServiceClient.Callback {
        private final ProgressDialog dialog;
        final private PlaybackServiceClient mClient;
        ...
        private DialogCallback(Context context, Runnable runnable) {
            mClient = new PlaybackServiceClient(context, this);
            mRunnable = runnable;
